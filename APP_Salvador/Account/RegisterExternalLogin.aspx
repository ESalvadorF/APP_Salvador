<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="APP_Salvador.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="APP_Salvador" %>
